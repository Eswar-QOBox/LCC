...
class _Step6MsmeScreenState extends State<Step6MsmeScreen> {
  ...
  void initState() {
    ...
    _path = submission.businessDocuments?.msmeCertificate?.path;
    _isPdf = submission.businessDocuments?.msmeCertificate?.isPdf ?? false;
  ...
  Future<void> _pickImage(ImageSource source) async {
    ...
    if (kIsWeb) {
      ...
      context.read<SubmissionProvider>().setMsmeCertificate(blobUrl, isPdf: false);
      return;
    }
    ...
    context.read<SubmissionProvider>().setMsmeCertificate(storedPath, isPdf: false);
  }
  ...
  Future<void> _pickPdf() async {
    ...
    context.read<SubmissionProvider>().setMsmeCertificate(path, isPdf: true);
  }
          ...
          children: [
            ...
            Builder(
              builder: (context) {
                ...
                final currentStep =
                    isPartnership && partnerCount > 0 ? (7 + 2 * partnerCount) : 8;
                    ...
                    PremiumCard(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Upload your MSME certificate (photo or PDF).',
                            style: theme.textTheme.bodySmall?.copyWith(
                              color: colorScheme.onSurfaceVariant,
                              height: 1.25,
                            ),

    ...
    try {
      ...
      if (e is DioException) {
        ...
        if (statusCode == 404) {
          ...
          errorMessage = 'Login endpoint not found. Please check if the server is running and the API endpoint is correct.';
  ...
  Future<String> refreshAccessToken(String refreshToken) async {
    try {
      ...
      if (e is DioException) {
        ...
        if (statusCode == 404) {
          errorCode = AuthErrorCodes.notFound;
          errorMessage = 'Refresh endpoint not found. Please check if the server is running and the API endpoint is correct.';
        } else if (statusCode == 401) {
  ...
  Future<User> getCurrentUser() async {
    try {
      ...
      if (e is DioException) {
        ...
        if (statusCode == 404) {
          errorCode = AuthErrorCodes.notFound;
          errorMessage = 'User endpoint not found. Please check if the server is running and the API endpoint is correct.';
        } else if (statusCode == 401) {
          errorCode = AuthErrorCodes.unauthorized;
